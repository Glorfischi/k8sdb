...
type FakeDatabases struct {
	Fake *FakeFischiV1alpha1
	ns   string
}

var databasesResource = schema.GroupVersionResource{Group: "fischi.me", Version: "v1alpha1", Resource: "databases"}

var databasesKind = schema.GroupVersionKind{Group: "fischi.me", Version: "v1alpha1", Kind: "Database"}
